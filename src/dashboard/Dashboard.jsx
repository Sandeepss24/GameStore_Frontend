    ...
    <main class="p-6 sm:p-10 space-y-6">
      <div class="flex flex-col space-y-6 md:space-y-0 md:flex-row justify-between">
        <div class="mr-6">
          ...
          <h2 class="text-gray-600 ml-0.5">Admin</h2>
        </div>
        <div class="flex flex-wrap items-start justify-end -mb-3">
          <Link to='/home'>
            <button class="inline-flex px-5 py-3 text-purple-600 hover:text-purple-700 focus:text-purple-700 hover:bg-purple-600 hover:text-white focus:bg-purple-100 border border-purple-600 rounded-md mb-3">
              <i class="fa-solid fa-dice-d20 pe-3 pt-1"></i>
              HOME PAGE
            </button>
          </Link>
          <Link to="/">
            <button class="inline-flex px-5 py-3 text-white bg-purple-600 hover:bg-purple-700 focus:bg-purple-700 rounded-md ml-6 mb-3">
              <i class="fa-solid fa-right-from-bracket pe-3 pt-1"></i>
              LOGOUT
            </button>
          </Link>
        </div>
      ...
      <section class="grid md:grid-cols-2 xl:grid-cols-4 gap-6">
        ...
        <div class="flex items-center p-8 bg-white shadow rounded-lg">
          ...
          <div>
            ...
            <span class="block text-gray-500">Average Sell</span>
          </div>
        </div>
        <div class="flex items-center p-8 bg-white shadow rounded-lg">
          ...
          <div>
            ...
            <span class="block text-gray-500">Underperforming Games</span>
          </div>
        </div>
        <div class="flex items-center p-8 bg-white shadow rounded-lg">
          ...
          <div>
            ...
            <span class="block text-gray-500">Finished Games</span>
          </div>
        </div>
      </section>
      <section class="grid md:grid-cols-2 xl:grid-cols-4 xl:grid-rows-3 xl:grid-flow-col gap-6">
        <div class="flex flex-col md:col-span-2 md:row-span-2 bg-white shadow rounded-lg">
          <div class="px-6 py-5 font-semibold border-b border-gray-100">The number of Buying and Signin Users per month</div>
          <div class="p-4 flex-grow">
            ...
            <img src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQqqhgz-RmpgOYabPEDR-Qr6Z_8P0xt7XxEdNO6Yc1uiWBWKSNQLtY5Cu9QGsGGR90WFW4&usqp=CAU' width="200px"/>
          </div>
        </div>
        <div class="flex items-center p-8 bg-white shadow rounded-lg">
        ...
        <div class="row-span-3 bg-white shadow rounded-lg">
          <div class="flex items-center justify-between px-6 py-5 font-semibold border-b border-gray-100">
            <span>Users by average sell</span>
        ...
        <div class="flex flex-col row-span-3 bg-white shadow rounded-lg">
          <div class="px-6 py-5 font-semibold border-b border-gray-100">Users by type of buying</div>
          <div class="p-4 flex-grow">
            <div class="flex items-center justify-center h-full px-4 py-24 text-gray-400 text-3xl font-semibold bg-gray-100 border-2 border-gray-200 border-dashed rounded-md">
              <img src='https://www.pngall.com/wp-content/uploads/10/Line-Chart-Transparent.png'/>
            </div>
          </div>
        </div>
      </section>
